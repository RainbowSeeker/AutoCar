...
%   Copyright 2018-2021 The MathWorks, Inc.
    ...
    properties(Access = private)
        ...
        %LastRefPoseOutput
        LastRefPoseOutput      = single([0 0 0])
        
        %LastRefVelocityOutput
        LastRefVelocityOutput  = single(0)
        
        %LastCurvatureOutput
        LastCurvatureOutput    = single(0)
        
        %LastDirectionOutput
        LastDirectionOutput    = single(1)
    end
    ...
    properties(Access = private, Nontunable)
        ...
        %
        %   Default:          false
        HasReferenceInports (1, 1) logical   = true
    end
    ...
    methods(Access = protected)
        ...
        function closestIdx = findClosestPathPoint(obj, pose, refPoses)
            ...
            if obj.DirectionsInternal(segStartIndex) == single(1) % forward driving uses front wheel as reference
        ...
        function nextFlag = moveToNext(obj, refPose, pose)
            ...
            if obj.DirectionsInternal(1) == single(1)
    ...
    methods(Access = protected)
        ...
        function validateInputsImpl(obj, currPose, currVelocity, varargin)
            ...
            validateattributes(currVelocity, {'single', 'double'}, {'nonnan', ...
